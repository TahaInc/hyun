      ...
      $(card)
        ...
        .each(function () {
          ...
          if (parsedUrl && (/youtube/g.test(parsedUrl[3]) || /vimeo/g.test(parsedUrl[3]))) {
                  ...
                  if (120 === (this.naturalWidth || this.width)) {
                    ...
                    switch (file) {
                      ...
                      default: // image not found
                        if (isBuilder) {
                          $img.css("background-image", 'url("assets/images/no-video.jpg")').show();
                        }
                    }
                  } else {
            ...
            $img.css("background-image", 'url("assets/images/video-placeholder.jpg")').show();
          }
        });
    }
  ...
  if (!isBuilder) {
    ...
    $(document).ready(function () {
      ...
      if ($.isMobile()) {
        ...
        var $animatedElements = $("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, textarea, .input-group, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info")
          .not(function () {
